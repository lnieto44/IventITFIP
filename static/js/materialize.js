	...
	*/
	 ...
	 * @param {Object=} options	Optional.
        ...
        offsetLeft : number -> offset from left. Default: 0
				activeClass : string -> Class nombre_cargo to be added to the active link. Default: active
	 * @returns {jQuery}
	 */
...
function PickerConstructor( ELEMENT, NAME, COMPONENT, OPTIONS ) {
    ...
    function prepareElement() {
        ...
        $ELEMENT.
            ...
            // Store the picker data by component nombre_cargo.
            data(NAME, P).

            // Add the “input” class nombre_cargo.
    ...
    function prepareElementHidden() {
        ...
        P._hidden = $(
            ...
            // Create the nombre_cargo using the original input’s with a prefix and suffix.
            'nombre_cargo="' + name + '"' +
